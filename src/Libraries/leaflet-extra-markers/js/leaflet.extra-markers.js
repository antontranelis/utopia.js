 ...
 */
    ...
    ExtraMarkers.Icon = L.ExtraMarkers.Icon = L.Icon.extend({
        ...
        _createSvg: function (shape, markerColor, borderColor) {
            var svgMap = {
        ...
        _createInner: function() {
            ...
            if (options.svg) {
                result += this._createSvg(options.shape, this._getColorHex(options.markerColor), this._getColorHex(options.svgBorderColor));
            }
