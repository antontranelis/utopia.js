...
utopiaMap.on('popupopen', function(e) {
  if (e.popup.type === "edit") {
    document.getElementById(e.popup.item.type + "form").addEventListener("submit", x => {
      ...
      if (e.popup.item.type === "home") homes.set(gun.get(form.get("lat") + "," + form.get("lng")).put(new Home(form.get("lat"), form.get("lng"), form.get("title"), form.get("text"), "")))
      if (e.popup.item.type === "offer") offers.set(gun.get(form.get("lat") + "," + form.get("lng")).put(new Offer(form.get("lat"), form.get("lng"), form.get("title"), form.get("text"), "")))
      if (e.popup.item.type === "need") needs.set(gun.get(form.get("lat") + "," + form.get("lng")).put(new Need(form.get("lat"), form.get("lng"), form.get("title"), form.get("text"), "")))
  ...
  if (e.popup.type === "view") {
    document.getElementById("deleteButton").addEventListener("click", event => {
      ...
      if (e.popup.item.type === "home") homes.get(e.popup.item._['#']).put(null)
      if (e.popup.item.type === "offer") offers.get(e.popup.item._['#']).put(null)
      if (e.popup.item.type === "need") needs.get(e.popup.item._['#']).put(null)
